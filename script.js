...
const games = [
 ...
 // 02/07/26
  new Game("Derek J", "Ira D", "d", 1),
  new Game("Derek J", "John R", "d", 1),
  new Game("Eric P", "Ira D", "d", 1),
  new Game("Chris B", "Brandon Y", "d", 1),
  new Game("Jodi H", "Jon N", "d", 1),
  new Game("Katherine F", "Andrew H", "d", 1),
  new Game("Steve M", "Jon N", "d", 1),
  new Game("Steve M", "Jodi H", "d", 1), 
  new Game("Chris B", "Steve M", "d", 1), 
  new Game("Sid S", "Aaron F", "d", 1),
  new Game("Eric P", "Aaron F", "d", 1),
...
//02/28/26
  new Game("Del C", "JJ T", "d", 1),
  new Game("JJ T", "Josh Z", "d", 1),
  new Game("Del C", "Ira D", "d", 1),
  new Game("Steve M", "Ira D", "d", 1),
  new Game("Andrew H", "Chris B", "d", 1),
  new Game("Steve M", "Graham M", "d", 1),
  new Game("Chris B", "John R", "d", 1),
  new Game("Ira D", "Alex G", "d", 1),
  new Game("JJ T", "Eric P", "d", 1),
  new Game("Brad J", "Hans E", "d", 1),
  new Game("Mikey B", "Del C", "d", 1),
  new Game("Mikey B", "Hans E", "d", 1),
  new Game("Brandon Y", null, "sym", 1),
  new Game("Katherine F", null, "sym", 1),

//03/07/26
  new Game("Mikey B", "Alex G", "d", 1),
  new Game("Alex G", "Katherine F", "d", 1),
  new Game("Katherine F", "Andrew H", "d", 1),
  new Game("Alex G", "Katherine F", "d", 1),
